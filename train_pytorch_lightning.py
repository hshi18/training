...
class IMAGENETDataModule(pl.LightningDataModule):
    ...
    def train_dataloader(self):
        return DataLoader(self.imagenet_train, batch_size=self.train_batch_size, num_workers = 2, shuffle=True)

    def val_dataloader(self):
        return DataLoader(self.imagenet_val, batch_size=self.val_batch_size, num_workers = 2)
...
trainer = pl.Trainer(max_epochs=EPOCHS,logger=None)
